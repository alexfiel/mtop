...
import { Car, FileText, UserCheck, Camera } from "lucide-react";
import type { MTOPVehicleInput } from "../types";
import { VehicleMediaUploader } from "./vehicle-media-uploader";

export interface EnrollVehicleFormProps {
...
export function EnrollVehicleForm({
  ...
  return (
    <div className="space-y-4 rounded-xl border bg-card p-4 shadow-2xs">
      ...
      {/* SECTION 4: VEHICLE PHOTO & LTO REGULATORY DOCUMENTS */}
      <div className="space-y-3 pt-2 border-t">
        ...
        <div className="space-y-3">
          {/* Vehicle Photo (Capture or Upload) */}
          <VehicleMediaUploader
            ...
            onChange={(url) => onChange({ vehicleImage: url })}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <VehicleMediaUploader
              ...
              description="Official CR document issued by LTO verifying vehicle registration"
              value={data.ltoCrDocument}
              onChange={(url) => onChange({ ltoCrDocument: url })}
              aspectMode="document"
              iconType="document"
            />
            ...
            <VehicleMediaUploader
              ...
              description="Valid official receipt confirming latest annual LTO registration dues"
              value={data.ltoOrDocument}
              onChange={(url) => onChange({ ltoOrDocument: url })}
              aspectMode="document"
              iconType="document"
            />
          </div>
